...
<!-- 		  Lista de Registrados al evento -->
		  <div class="container col-6">
		  	<h1 class="text-start fs-1">Consulta de Personas</h1>
		  	<a class ="btn" type="button" style="background-color: #96c93e; color: white; border-radius: 8px;" id="Agregar" href="Controlador?accion=add">Agregar Nuevo</a>
		  </div>
		  <table class="table">
			  <thead>
			    <tr>
			  ...
			  <tbody>
			    <tr>
			      ...
			      <td>
			      	<a class ="btn btn-warning" type="button" id="Editar" href="Controlador?accion=editar&id=<%=per.getId()%>">Editar</a>
			      	<a class ="btn btn-danger" type="button" id="Eliminar" href="Controlador?accion=eliminar&id=<%=per.getId()%>" >Eliminar</a>
			      </td>
			    </tr>
			  </tbody>
			  <%} %>
