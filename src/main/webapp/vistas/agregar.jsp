...
<head>
  ...
  <title>Proyecto Final CaC Agregar Personas</title>
  <link rel="stylesheet" href="css/bootstrap.min.css">
	...
	<div class="container col-6">
		<h1 class="text-start fs-1 row">Alta de Personas</h1>
	    <form action="Controlador">
			<div class="row py-3">
	        <div class="col">
	          <input type="text" class="form-control" placeholder="Nombre y Apellido" aria-label="Nombre" id="Nombre" name="txtNom">
	        </div>
	      </div>
	        <div class="col">
	          <input type="number" class="form-control" placeholder="DNI" aria-describedby="dni" id="dni" name="txtDNI">
	        </div>
	        <div class="row py-3">
	           <div class="col">
	            <input class ="btn col-12" type="submit" style="background-color: #96c93e; color: white; border-radius: 8px;" id="Agregar" name="accion" value="Agregar">
	          </div>
	          <div class="col">
